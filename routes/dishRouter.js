...
.post(cors.corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin, (req,res,next)=>{ //Execute the middleware first when the post request is received
...
.post(cors.corsWithOptions,authenticate.verifyUser,(req, res, next) => {
    ...
    .then((dish) => {
        if (dish != null) {
            //Automatically add the author field from req.user that is loaded by the passport auth
